...
//	This is Project 3: Texture Mapping
//
//	The objective is to apply texture to an object with the ability to 
//  distort the texture on the object
//
...
const char *WINDOWTITLE = { "Project 3: Texture Mapping -- Nathaniel Mohr" };
...
void InitTextures() {
	...
	unsigned char* tex = BmpToTexture("worldtex.bmp", &width, &height);
	...
	glTexImage2D(GL_TEXTURE_2D, level, ncomps, width, height, border, GL_RGB, GL_UNSIGNED_BYTE, tex);
}
