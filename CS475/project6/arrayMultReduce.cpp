...
const char *			CL_FILE_NAME = { "arrayMultReduce.cl" };
...
main( int argc, char *argv[ ] )
{
	...
	double performance = (double)NUM_ELEMENTS/(time1-time0)/1000000000.;
	printf("Array size = %8d, Block size = %4d, Performance = %6.3lf GigaMultsPerSecond\n",
		NUM_ELEMENTS, LOCAL_SIZE, performance);

	fp = fopen("arrayMultReduce.csv", "a");
	fprintf(fp, ",%lf", performance);
	fclose(fp);
#ifdef WIN32
	Sleep( 2000 );
#endif
