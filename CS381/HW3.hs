...
-- | (x + 2) * 3 * y
expr3 :: Expr
expr3 = Mul (Group (Add (Ref "x") (Lit 2))) (Mul (Lit 3) (Ref "y"))
...
prettyExpr (Group a) = "(" ++ prettyExpr a ++ ")"
...
prettyCmd (Pen a) = concat["pen ", prettyMode a]
prettyCmd (Move a b) = concat["move(", prettyExpr a, ", ", prettyExpr b, ")"]
prettyCmd (Call m a) = concat[m, "(", (intercalate ", " (map prettyExpr a)), ")"]
prettyCmd (For v x y b) = concat["for ", v, " = ", prettyExpr x, " to ", prettyExpr y, " ", prettyBlock b]
